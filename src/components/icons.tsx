...
/** Wi-fi with a strike through it — the offline screen's picture. */
export const IconWifiOff = (p: IconProps) => (
  <Icon {...p}>
    <line x1="2" y1="2" x2="22" y2="22" />
    <path d="M8.5 16.4a6 6 0 0 1 6.95 0" />
    <path d="M5 12.86a10.94 10.94 0 0 1 5.17-2.39" />
    <path d="M10.71 5.05A16 16 0 0 1 22.58 9" />
    <path d="M1.42 9a15.91 15.91 0 0 1 4.7-2.88" />
    <path d="M16.85 11.25a10.97 10.97 0 0 1 2.22 1.68" />
    <line x1="12" y1="20" x2="12.01" y2="20" />
  </Icon>
);
