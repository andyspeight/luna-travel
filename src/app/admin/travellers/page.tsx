          ...
          <div style={{ padding: '16px 24px', borderBottom: `1px solid ${C.border}` }}>
            ...
            <div style={{ fontSize: 13, color: C.textTertiary, marginTop: 2 }}>
              {invites.length === 0
                ...
                : `${invites.length} invite${invites.length === 1 ? '' : 's'} this session`}
            </div>
          </div>
              ...
              {invites.map((inv) => (
                <div key={inv.inviteId} style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontSize: 12, fontFamily: 'ui-monospace, monospace', color: C.textSecondary,
                    ...
                    >
                      <ExternalLink style={{ height: 14, width: 14 }} strokeWidth={1.75} />
                    </a>
                  </div>
                </div>
              ))}
