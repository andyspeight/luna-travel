...
// Agency-scoped invite generator (its own "Invite" tab). Pinned to one agency,
// so the invite is tagged with agency.id (the canonical Control record id) and
// resolves that agency's real booking. The travellers list lives on the
// Travellers tab; the cross-agency generator lives at /admin/travellers.
