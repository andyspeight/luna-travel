...
const S: Record<string, Dict> = {
  ...
  'me.signOutConfirm': { en: 'This removes your trip and its saved documents from this phone.', ro: 'Călătoria și documentele salvate vor fi șterse de pe acest telefon.', fr: 'Votre voyage et ses documents enregistrés seront supprimés de ce téléphone.', de: 'Ihre Reise und die gespeicherten Dokumente werden von diesem Telefon entfernt.', es: 'Se borrarán de este teléfono tu viaje y sus documentos guardados.', it: 'Il viaggio e i documenti salvati verranno rimossi da questo telefono.' },
  'me.signOutYes': { en: 'Sign out of this phone', ro: 'Deconectează acest telefon', fr: 'Me déconnecter de ce téléphone', de: 'Auf diesem Telefon abmelden', es: 'Cerrar sesión en este teléfono', it: 'Esci da questo telefono' },
  'me.signOutCancel': { en: 'Cancel', ro: 'Anulează', fr: 'Annuler', de: 'Abbrechen', es: 'Cancelar', it: 'Annulla' },
  'me.signingOut': { en: 'Signing out…', ro: 'Se deconectează…', fr: 'Déconnexion…', de: 'Abmelden…', es: 'Cerrando sesión…', it: 'Uscita in corso…' },
  'me.signOutOffline': { en: 'Signing out needs a connection. Please try again when you have signal.', ro: 'Pentru deconectare ai nevoie de conexiune. Încearcă din nou când ai semnal.', fr: 'La déconnexion nécessite une connexion. Réessayez lorsque vous aurez du réseau.', de: 'Zum Abmelden brauchen Sie eine Verbindung. Bitte versuchen Sie es erneut, wenn Sie Empfang haben.', es: 'Para cerrar sesión necesitas conexión. Inténtalo de nuevo cuando tengas señal.', it: 'Per uscire serve una connessione. Riprova quando hai campo.' },
  'offline.savedTrip': { en: 'No connection. This is your trip as last updated {when}.', ro: 'Fără conexiune. Aceasta este călătoria ta, actualizată ultima dată {when}.', fr: 'Pas de connexion. Voici votre voyage tel qu’il était le {when}.', de: 'Keine Verbindung. Dies ist Ihre Reise mit dem Stand vom {when}.', es: 'Sin conexión. Este es tu viaje tal como estaba el {when}.', it: 'Nessuna connessione. Questo è il tuo viaggio aggiornato al {when}.' },
