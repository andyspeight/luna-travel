...
// Agency-scoped invite generator. Rendered inside the agency detail page's
// "Travellers" tab, so it is already pinned to one agency — no dropdown. The
// invite is tagged with agency.id, which is the canonical Control record id
// (rec...), so every invite created here resolves that agency's real booking.
// (The cross-agency version of this lives at /admin/travellers in the left nav.)
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, alignItems: 'start' }}>
        ...
        <Card>
          ...
          <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
            {/* Scoped context: this agency, with its real record id */}
            <div style={{
