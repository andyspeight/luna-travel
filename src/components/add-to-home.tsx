...
export function AddToHomeRow() {
  ...
  // Already running from the home screen: show a confirmation row rather than
  // disappearing — a silently absent button reads as a bug, not a success.
  if (isStandalone) {
    return (
      <div className="w-full flex items-center gap-3 p-4 text-left">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-sm font-medium text-ink">On your home screen</div>
          <div className="text-xs text-ink-2 mt-0.5">You&rsquo;re using the installed app</div>
        </div>
      </div>
    );
  }
