...
export const MALDIVES_SWAN: Booking = {
  ...
  documents: [
    { id: 'd1', name: 'Full booking pack', kind: 'booking-pack', url: '#', sizeBytes: 4_200_000, updatedAt: '2026-05-14T09:00:00.000Z' },
    { id: 'd2', name: 'E-tickets · Etihad', kind: 'e-ticket', url: '#', sizeBytes: 412_000, updatedAt: '2026-05-14T09:00:00.000Z' },
    { id: 'd3', name: 'Hotel voucher · Avyanna', kind: 'voucher', url: '#', sizeBytes: 268_000, updatedAt: '2026-05-14T09:00:00.000Z' },
    { id: 'd4', name: 'No1 Lounge pass · LGW', kind: 'lounge-pass', url: '#', sizeBytes: 184_000, updatedAt: '2026-05-14T09:00:00.000Z' },
    { id: 'd5', name: 'ATOL certificate', kind: 'atol', url: '#', sizeBytes: 96_000, updatedAt: '2026-05-14T09:00:00.000Z' },
    { id: 'd6', name: 'Travel insurance summary', kind: 'insurance', url: '#', sizeBytes: 320_000, updatedAt: '2026-05-14T09:00:00.000Z' },
  ],
...
export const MALLORCA_WATSON: Booking = {
  ...
  documents: [
    { id: 'd1', name: 'Full booking pack', kind: 'booking-pack', url: '#', sizeBytes: 3_800_000, updatedAt: '2026-05-12T11:30:00.000Z' },
    { id: 'd2', name: 'E-tickets · Jet2', kind: 'e-ticket', url: '#', sizeBytes: 388_000, updatedAt: '2026-05-12T11:30:00.000Z' },
    { id: 'd3', name: 'Hotel voucher · Iberostar', kind: 'voucher', url: '#', sizeBytes: 244_000, updatedAt: '2026-05-12T11:30:00.000Z' },
    { id: 'd4', name: 'Parking voucher · BHX', kind: 'voucher', url: '#', sizeBytes: 88_000, updatedAt: '2026-05-12T11:30:00.000Z' },
    { id: 'd5', name: 'ATOL certificate', kind: 'atol', url: '#', sizeBytes: 96_000, updatedAt: '2026-05-12T11:30:00.000Z' },
  ],
...
export const DUBAI_PATEL: Booking = {
  ...
  documents: [
    { id: 'd1', name: 'Full booking pack', kind: 'booking-pack', url: '#', sizeBytes: 5_120_000, updatedAt: '2026-05-13T14:15:00.000Z' },
    { id: 'd2', name: 'E-tickets · Emirates Business', kind: 'e-ticket', url: '#', sizeBytes: 462_000, updatedAt: '2026-05-13T14:15:00.000Z' },
    { id: 'd3', name: 'Hotel voucher · Atlantis', kind: 'voucher', url: '#', sizeBytes: 288_000, updatedAt: '2026-05-13T14:15:00.000Z' },
    { id: 'd4', name: 'Hotel voucher · Burj Al Arab', kind: 'voucher', url: '#', sizeBytes: 312_000, updatedAt: '2026-05-13T14:15:00.000Z' },
    { id: 'd5', name: 'ATOL certificate', kind: 'atol', url: '#', sizeBytes: 96_000, updatedAt: '2026-05-13T14:15:00.000Z' },
    { id: 'd6', name: 'Travel insurance summary', kind: 'insurance', url: '#', sizeBytes: 340_000, updatedAt: '2026-05-13T14:15:00.000Z' },
  ],
...
export const ATHENS_MITCHELL: Booking = {
  ...
  airportExtras: [],
  documents: [
    { id: 'd1', name: 'Full booking pack', kind: 'booking-pack', url: '#', sizeBytes: 1_800_000, updatedAt: '2026-05-10T16:00:00.000Z' },
    { id: 'd2', name: 'Hotel voucher · Electra', kind: 'voucher', url: '#', sizeBytes: 220_000, updatedAt: '2026-05-10T16:00:00.000Z' },
  ],
