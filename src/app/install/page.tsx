          ...
          <>
            ...
            <div className="w-full max-w-[420px] bg-white/10 backdrop-blur-md rounded-2xl border border-white/15 p-5 shadow-2xl">
              ...
              <button
                ...
                onClick={() => void submit()}
                disabled={!canSubmit}
                className="w-full mt-4 h-12 rounded-xl bg-teal text-teal-on font-semibold text-[15px] disabled:opacity-50 disabled:cursor-not-allowed enabled:hover:bg-teal-dark transition-colors flex items-center justify-center gap-2"
              >
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={onOpen}
          className="w-full max-w-[360px] h-14 rounded-2xl bg-teal text-teal-on font-semibold text-[16px] hover:bg-teal-dark transition-colors flex items-center justify-center gap-2 shadow-2xl"
        >
          Open my trip
